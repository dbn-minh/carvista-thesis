  ...
  return (
    <section className="section-shell p-4 sm:p-5 md:p-6">
      ...
      <div className="mt-6 grid gap-6 xl:grid-cols-[1.2fr_0.8fr]">
            ...
            <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
              {photos.map((photo, index) => (
                <div key={photo.id} className="overflow-hidden rounded-[24px] border border-cars-primary/10 bg-white shadow-[0_12px_28px_rgba(15,45,98,0.06)] dark:border-cars-gray-light/35 dark:bg-slate-950/55">
                  <div className="relative aspect-[4/3] overflow-hidden bg-cars-off-white dark:bg-slate-900/80">
                  ...
                  <div className="space-y-3 p-4">
                    ...
                    <div className="grid gap-2 sm:flex sm:flex-wrap">
                      <button
                        ...
                        className="inline-flex min-h-9 items-center justify-center rounded-full border border-cars-primary/15 px-3 py-1.5 text-xs font-semibold text-cars-primary disabled:opacity-40"
                      >
                        Set cover
                      </button>
                      <button
                        ...
                        disabled={index === 0}
                        className="inline-flex min-h-9 items-center justify-center gap-1 rounded-full border border-cars-primary/15 px-3 py-1.5 text-xs font-semibold text-cars-primary disabled:opacity-40"
                      >
                      ...
                      <button
                        ...
                        className="inline-flex min-h-9 items-center justify-center gap-1 rounded-full border border-red-200 px-3 py-1.5 text-xs font-semibold text-red-600"
                      >
        ...
        <div className="rounded-[24px] border border-cars-primary/10 bg-white p-4 shadow-[0_12px_28px_rgba(15,45,98,0.05)] dark:border-cars-gray-light/35 dark:bg-slate-950/55 sm:p-5">
